...
conn = database.connect(host="mysql-database-fridge-database-maturita.i.aivencloud.com",
                        user="avnadmin",
                        passwd="AVNS_cm9FRnWakqiiuXBng6y",
                        database="food_schem",
                        port=16794,
                        )
...
def upload_product_to_database(product_array, refresh_function):
    ...
    if len(result)>0:
        ...
        #obnovení hlavni aplikace
        print(final_expiration_date)
