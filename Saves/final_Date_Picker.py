...
class MyDatePicker(Popup):
    ...
    def create_ui(self):
        ...
        month_change_layout = MDBoxLayout(
            orientation='horizontal', size_hint=(None, None), width=170, spacing=5, height=40
        )
        ...
        self.selected_dates_displayed_layout = MDBoxLayout(
            orientation='horizontal', size_hint=(1, None), size=(300, 40), spacing=10, padding=[10, 0, 0, 0]
        )
    ...
    def open_date_picker(self, close_callback = None):
